  ...
  return this.each(() => {
    ...
    function initialisePage() {
      ...
      $(settings.dom.wrapperID).append(
        `<div id="${settings.dom.tickerID.replace('#', '')}" class="ticker">
           <div id="${settings.dom.titleID.replace('#', '')}" class="ticker-title">
             <span><!-- --></span>
           </div>
           <p id="${settings.dom.contentID.replace('#', '')}" class="ticker-content"></p>
           <div id="${settings.dom.revealID.replace('#', '')}" class="ticker-swipe">
             <span><!-- --></span>
           </div>
        </div>`);
      ...
      if (opts.controls) {
        ...
        $(settings.dom.wrapperID).append(
          `<ul id="${settings.dom.controlsID.replace('#', '')}" class="ticker-controls">
             <li id="${settings.dom.playPauseID.replace('#', '')}" class="jnt-play-pause controls"><a href=""><!-- --></a></li>
             <li id="${settings.dom.prevID.replace('#', '')}" class="jnt-prev controls"><a href=""><!-- --></a></li>
             <li id="${settings.dom.nextID.replace('#', '')}" class="jnt-next controls"><a href=""><!-- --></a></li>
          </ul>`);
      }
